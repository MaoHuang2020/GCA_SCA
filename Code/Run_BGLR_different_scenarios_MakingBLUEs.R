...
source(paste0(WD,"OneTime1920/","BGLR_functions_withFMLoc.R")) # terminal
...
for (i in 1:5){
  ...
  dir.create(paste0("withFMLocRep",i))
  savepath<-paste0("OneTime1920/Alldata_output/withFMLocRep",i,"/")  # the path following WD
...
for (i in 1:reps){
  setwd(paste0(WD,"OneTime1920/Alldata_CV_output/"))
  dir.create(paste0("withFMLocRep",i))
  savepath<-paste0("OneTime1920/Alldata_CV_output/withFMLocRep",i,"/")  #the path following WD
